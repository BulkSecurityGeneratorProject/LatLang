...
class EntryGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Entry entity")
        ...
        .repeat(2) {
            ...
            .post("/api/entries")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "address":"SAMPLE_TEXT", "city":"SAMPLE_TEXT", "country":"SAMPLE_TEXT", "postal_code":"SAMPLE_TEXT", "state_province":"SAMPLE_TEXT", "country1":"SAMPLE_TEXT", "google_verified_address":"SAMPLE_TEXT", "latitude":"SAMPLE_TEXT", "longitude":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
