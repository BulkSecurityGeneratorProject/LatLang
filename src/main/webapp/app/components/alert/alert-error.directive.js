(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('adobeLatLangApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-adobeLatLangApp-error');
                var entityKey = httpResponse.headers('X-adobeLatLangApp-params');
                if (errorHeader) {
